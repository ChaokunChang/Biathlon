...
sudo /home/ckchang/anaconda3/envs/apx/bin/python R2-W1-F1.py --task final/tripsralfv2 --model lgbm --max_error 1.5 --scheduler_batch 2 --nreqs 22016
sudo /home/ckchang/anaconda3/envs/apx/bin/python R2-W1-F1.py --task final/turbofan --model rf --max_error 4.88 --scheduler_batch 9 --nreqs 769
sudo /home/ckchang/anaconda3/envs/apx/bin/python R2-W1-F1.py --task final/batteryv2 --model lgbm --max_error 189.0 --scheduler_batch 5 --nreqs 564
