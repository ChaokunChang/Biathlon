sudo /home/ckchang/anaconda3/envs/apx/bin/python R2-W1-F3.py --tasks tripsralfv2 tripsralfv2median --metric r2 --erid 20 --phase e2e
...
sudo /home/ckchang/anaconda3/envs/apx/bin/python R2-W1-F3.py --tasks tdfraudralf2d tdfraudralf2dmedian --erid 20 --phase e2e
