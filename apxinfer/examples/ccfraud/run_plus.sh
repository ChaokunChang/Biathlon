...
python online.py --task cc_fraud_plus --model xgb --pest_constraint error --max_error 0 --min_conf 0.99 --ncfgs 3 --plus
python online.py --task cc_fraud_plus --model xgb --pest_constraint error --max_error 0 --min_conf 1.0 --ncfgs 3 --plus
python online.py --task cc_fraud_plus --model xgb --pest_constraint error --max_error 0 --min_conf 0.99 --ncfgs 10 --plus
python online.py --task cc_fraud_plus --model xgb --pest_constraint error --max_error 0 --min_conf 1.0 --ncfgs 10 --plus