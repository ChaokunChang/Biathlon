...
python online.py --task trips_plus --model lgbm --max_relative_error 0.1 --min_conf 0.99 --n_cfgs 5 --plus
python online.py --task trips_plus --model lgbm --max_relative_error 0.1 --min_conf 1.0 --n_cfgs 5 --plus 
python online.py --task trips_plus --model lgbm --max_relative_error 0.1 --min_conf 0.99 --n_cfgs 3 --plus
python online.py --task trips_plus --model lgbm --max_relative_error 0.1 --min_conf 0.99 --n_cfgs 10 --plus