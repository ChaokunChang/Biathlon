...
class TrafficQP0(XIPQuery):
    ...
    def run(self, request: TrafficRequest, qcfg: XIPQueryConfig) -> XIPFeatureVec:
        ...
        fvals = np.array([request['req_year'], request['req_month'], request['req_day'], request['req_hour'], borough])
...
class TrafficQP1(XIPQuery):
    def __init__(self, key: str, data_loader: TrafficFStoreLoader) -> None:
        ...
        fnames = ['last_hour_cnt',
                  ...
                  'last_hour_std_speed', 'last_hour_std_travel_time',
                  'last_hour_min_speed', 'last_hour_min_travel_time',
                  'last_hour_max_speed', 'last_hour_max_travel_time',
                  'last_hour_median_speed', 'last_hour_median_travel_time'
                  ]
        cfg_pools = [XIPQueryConfig(qname=key,
                                    qtype='fstore',
                                    qcfg_id=0,
...
class TrafficQP2(XIPQuery):
    def __init__(self, key: str, data_loader: TrafficHourDataLoader, n_cfgs: int = 100) -> None:
        fnames = ['this_hour_cnt',
                  ...
                  'this_hour_min_speed', 'this_hour_min_travel_time',
...
class TrafficQP3(XIPQuery):
    def __init__(self, key: str, data_loader: TrafficFStoreLoader) -> None:
        ...
        fnames = ['last_day_cnt',
                  ...
                  'last_day_std_speed', 'last_day_std_travel_time',
                  'last_day_min_speed', 'last_day_min_travel_time',
                  'last_day_max_speed', 'last_day_max_travel_time',
                  'last_day_median_speed', 'last_day_median_travel_time'
                  ]
        cfg_pools = [XIPQueryConfig(qname=key,
                                    qtype='fstore',
                                    qcfg_id=0,
...
class TrafficQP4(XIPQuery):
    def __init__(self, key: str, data_loader: TrafficFStoreLoader) -> None:
        ...
        fnames = ['last_dayhour_cnt',
                  ...
                  'last_dayhour_std_speed', 'last_dayhour_std_travel_time',
                  'last_dayhour_min_speed', 'last_dayhour_min_travel_time',
                  'last_dayhour_max_speed', 'last_dayhour_max_travel_time',
                  'last_dayhour_median_speed', 'last_dayhour_median_travel_time'
                  ]
        cfg_pools = [XIPQueryConfig(qname=key,
                                    qtype='fstore',
                                    qcfg_id=0,
