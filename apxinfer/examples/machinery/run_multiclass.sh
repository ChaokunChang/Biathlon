...
python online.py --task machinery_multiclass --model mlp --pest_constraint error --max_error 0 --min_conf 0.99 --ncfgs 3 --multiclass
python online.py --task machinery_multiclass --model mlp --pest_constraint error --max_error 0 --min_conf 1.0 --ncfgs 3 --multiclass
python online.py --task machinery_multiclass --model mlp --pest_constraint error --max_error 0 --min_conf 0.99 --ncfgs 10 --multiclass
python online.py --task machinery_multiclass --model mlp --pest_constraint error --max_error 0 --min_conf 1.0 --ncfgs 10 --multiclass